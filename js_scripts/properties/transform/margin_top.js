...
export default function setUpMarginTop() {
	...
	if (marginTopInput && marginTopSelect) {
		...
		marginTopInput.addEventListener('input', () => changeElementStyle(['margin-top'], marginTopInput, marginTopSelect))

		marginTopSelect.addEventListener('focusout', saveDataIntoElement)
		marginTopSelect.addEventListener('change', () => changeElementStyle(['margin-top'], marginTopInput, marginTopSelect))
	}
}
