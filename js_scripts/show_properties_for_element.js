...
const availablePropertiesForElements = {
	...
	BUTTON: [Properties.TRANSFORM, Properties.APPEARANCE],
	INPUT: [Properties.TRANSFORM, Properties.APPEARANCE],
	SELECT: [Properties.TRANSFORM, Properties.APPEARANCE],
	TEXT: [Properties.TRANSFORM, Properties.APPEARANCE, Properties.TEXT],
	OPTION: [Properties.TRANSFORM, Properties.APPEARANCE],
